...
public class RequestResourceOfCreator {

    private final Logger log = LoggerFactory.getLogger(RequestResourceOfCreator.class);
    ...
    public RequestResourceOfCreator(RequestService requestService, RequestMapper requestMapper) {
