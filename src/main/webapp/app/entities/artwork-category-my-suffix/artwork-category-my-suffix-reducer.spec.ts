...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './artwork-category-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ARTWORKCATEGORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_ARTWORKCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ARTWORKCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ARTWORKCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ARTWORKCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ARTWORKCATEGORY actions', async () => {
      const expectedActions = [
        {
