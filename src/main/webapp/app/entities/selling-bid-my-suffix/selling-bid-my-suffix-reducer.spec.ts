...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './selling-bid-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SELLINGBID_LIST actions', async () => {
    ...
    it('dispatches FETCH_SELLINGBID actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SELLINGBID actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SELLINGBID actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SELLINGBID actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SELLINGBID actions', async () => {
      const expectedActions = [
        {
