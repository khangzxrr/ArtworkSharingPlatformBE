...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './request-progress-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REQUESTPROGRESS_LIST actions', async () => {
    ...
    it('dispatches FETCH_REQUESTPROGRESS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REQUESTPROGRESS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REQUESTPROGRESS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REQUESTPROGRESS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REQUESTPROGRESS actions', async () => {
      const expectedActions = [
        {
