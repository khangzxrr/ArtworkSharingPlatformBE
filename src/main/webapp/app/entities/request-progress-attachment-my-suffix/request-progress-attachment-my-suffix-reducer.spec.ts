...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './request-progress-attachment-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REQUESTPROGRESSATTACHMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_REQUESTPROGRESSATTACHMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REQUESTPROGRESSATTACHMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REQUESTPROGRESSATTACHMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REQUESTPROGRESSATTACHMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REQUESTPROGRESSATTACHMENT actions', async () => {
      const expectedActions = [
        {
