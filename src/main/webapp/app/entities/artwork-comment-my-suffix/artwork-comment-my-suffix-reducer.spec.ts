...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './artwork-comment-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ARTWORKCOMMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_ARTWORKCOMMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ARTWORKCOMMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ARTWORKCOMMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ARTWORKCOMMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ARTWORKCOMMENT actions', async () => {
      const expectedActions = [
        {
