...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './artwork-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ARTWORK_LIST actions', async () => {
    ...
    it('dispatches FETCH_ARTWORK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ARTWORK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ARTWORK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ARTWORK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ARTWORK actions', async () => {
      const expectedActions = [
        {
