...
import { getEntity, deleteEntity } from './artwork-my-suffix.reducer';

export const ArtworkMySuffixDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="artworkSharingPlatformJhipterApp.artwork.delete.question">
        Are you sure you want to delete Artwork {artworkEntity.id}?
      </ModalBody>
      <ModalFooter>
...
export default ArtworkMySuffixDeleteDialog;
