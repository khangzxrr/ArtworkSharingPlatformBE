...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './artwork-complain-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ARTWORKCOMPLAIN_LIST actions', async () => {
    ...
    it('dispatches FETCH_ARTWORKCOMPLAIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ARTWORKCOMPLAIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ARTWORKCOMPLAIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ARTWORKCOMPLAIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ARTWORKCOMPLAIN actions', async () => {
      const expectedActions = [
        {
