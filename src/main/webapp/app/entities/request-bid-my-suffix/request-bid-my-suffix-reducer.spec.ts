...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './request-bid-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REQUESTBID_LIST actions', async () => {
    ...
    it('dispatches FETCH_REQUESTBID actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REQUESTBID actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REQUESTBID actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REQUESTBID actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REQUESTBID actions', async () => {
      const expectedActions = [
        {
