...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './request-attachment-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REQUESTATTACHMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_REQUESTATTACHMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REQUESTATTACHMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REQUESTATTACHMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REQUESTATTACHMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REQUESTATTACHMENT actions', async () => {
      const expectedActions = [
        {
