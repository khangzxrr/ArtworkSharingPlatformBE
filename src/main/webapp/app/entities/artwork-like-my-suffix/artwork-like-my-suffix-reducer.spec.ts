...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './artwork-like-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ARTWORKLIKE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ARTWORKLIKE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ARTWORKLIKE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ARTWORKLIKE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ARTWORKLIKE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ARTWORKLIKE actions', async () => {
      const expectedActions = [
        {
