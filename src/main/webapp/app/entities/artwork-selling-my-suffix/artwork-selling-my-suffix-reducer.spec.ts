...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './artwork-selling-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ARTWORKSELLING_LIST actions', async () => {
    ...
    it('dispatches FETCH_ARTWORKSELLING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ARTWORKSELLING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ARTWORKSELLING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ARTWORKSELLING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ARTWORKSELLING actions', async () => {
      const expectedActions = [
        {
