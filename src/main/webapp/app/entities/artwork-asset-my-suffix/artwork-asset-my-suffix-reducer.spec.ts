...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './artwork-asset-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ARTWORKASSET_LIST actions', async () => {
    ...
    it('dispatches FETCH_ARTWORKASSET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ARTWORKASSET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ARTWORKASSET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ARTWORKASSET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ARTWORKASSET actions', async () => {
      const expectedActions = [
        {
