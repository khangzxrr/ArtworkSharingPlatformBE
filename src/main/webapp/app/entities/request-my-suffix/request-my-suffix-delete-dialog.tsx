...
import { getEntity, deleteEntity } from './request-my-suffix.reducer';

export const RequestMySuffixDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="artworkSharingPlatformJhipterApp.request.delete.question">
        Are you sure you want to delete Request {requestEntity.id}?
      </ModalBody>
      <ModalFooter>
...
export default RequestMySuffixDeleteDialog;
