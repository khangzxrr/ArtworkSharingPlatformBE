...
export const RequestMySuffix = () => {
  ...
  return (
    <div>
      <h2 id="request-my-suffix-heading" data-cy="RequestHeading">
        Requests
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} /> Refresh list
          </Button>
          <Link to="/request-my-suffix/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
...
export default RequestMySuffix;
